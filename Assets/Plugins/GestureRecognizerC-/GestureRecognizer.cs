...
public class GestureRecognizer
{
    ...
    public static event Action<System.Object> FigureRecognized = delegate { };
    ...
    static void gestureMatch(ArrayList pointArray) 
    {
	    ...
	    if (score < 0.7f)
        {
		    ...
		    //Gesture.GUITextProperty.text = "RESULT: NO MATCH " +  "\n" + "SCORE: " + Mathf.Round(100 * score) +"%";


	    } else {
		    Debug.Log("RESULT: " + GestureTemplates.TemplateNames[count] + " SCORE: " + score);
            FigureRecognized(GestureTemplates.TemplateNames[count]);
		    //Gesture.GUITextProperty.text = "RESULT: " + GestureTemplates.TemplateNames[count] + "\n" + "SCORE: " + Mathf.Round(100 * score) +"%";
	    }
